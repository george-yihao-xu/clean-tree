...
input_csv = os.path.join(script_dir, 'Trees_SiteScale.csv')  # Absolute path to the input CSV file
output_csv = os.path.join(script_dir, 'Cleaned_Trees_SiteScale.csv')  # Absolute path to the output CSV file
